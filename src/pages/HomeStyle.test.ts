...
describe('home hero visual styles', () => {
  ...
  it('uses an S-shaped process path that matches the minimal site style', () => {
    ...
    expect(getRule('.home-minimal-process-item:nth-of-type(2)')).toContain('transform: translateY(-46px)')
    expect(getRule('.home-minimal-process-item:nth-of-type(3)')).toContain('transform: translateY(4px)')
