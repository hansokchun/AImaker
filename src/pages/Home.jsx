        ...
        <main>
            ...
            <section className="categories container">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3rem' }}>
                    ...
                    <Link to="/category" className="btn-text" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--primary)' }}>
                        전체보기 <span className="material-symbols-outlined">arrow_forward</span>
                    </Link>
                </div>
                <div className="category-grid">
                    <Link to="/category" className="category-card"><div className="category-icon">🎬</div><h3 className="category-name">AI 영화 제작</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">✨</div><h3 className="category-name">AI 애니메이션</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">📱</div><h3 className="category-name">AI 광고 제작</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">🎨</div><h3 className="category-name">AI 이미지 제작</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">👤</div><h3 className="category-name">AI 캐릭터 제작</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">🎵</div><h3 className="category-name">AI 음원 만들기</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">🎙️</div><h3 className="category-name">AI 성우 입히기</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">🖌️</div><h3 className="category-name">AI 그래픽 디자인</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">📹</div><h3 className="category-name">AI 클립 구매</h3></Link>
                    <Link to="/category" className="category-card"><div className="category-icon">⚡</div><h3 className="category-name">AI 프롬프트 구매</h3></Link>
                </div>
            </section>
            ...
            <section className="recent-requests-section">
                <div className="container">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3rem' }}>
                        ...
                        <Link to="/requests" className="btn-text" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--primary)' }}>
                            게시판 가기 <span className="material-symbols-outlined">arrow_forward</span>
                        </Link>
                    </div>
                    <div className="request-mini-grid">
                        {/* Mini Cards */}
                        <Link to="/requests" className="request-mini-card">
