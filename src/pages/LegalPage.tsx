...
const termsSections = [
    {
        title: '사업자 및 고객센터',
        body: '상호는 원코리아이며 대표자는 태영호, 사업자등록번호는 107-39-44459입니다. 사업장 주소는 서울특별시 영등포구 영중로 61, 7층 2호(영등포동6가, 극동빌딩)입니다. 통신판매업 신고번호, 고객센터 이메일 및 전화번호는 현재 미정이며, 정식 결제 오픈 전 확정하여 고지합니다.',
    },
    {
        title: '서비스 이용',
        body: '긱온은 의뢰자와 전문가가 AI 작업을 의뢰, 제안, 결제, 작업 진행, 결과물 승인까지 관리하는 중개형 마켓플레이스입니다. 사용자는 정확한 계정 정보와 거래 정보를 제공해야 하며, 외부 연락처 유도나 플랫폼 밖 결제 요청은 제한됩니다.',
    },
    {
        title: '결제와 작업 진행',
...
const privacySections = [
    ...
    {
        title: '결제와 정산 정보',
        body: '카드번호 등 결제수단의 민감 정보는 Toss Payments가 처리하며 긱온은 결제 승인 키, 주문번호, 금액, 거래 상태를 저장합니다. 전문가 정산 계좌 정보는 정산 확인과 송금 처리 목적으로 사용됩니다.',
    },
    {
        title: '알림 발송',
    ...
    {
        title: '개인정보 보호책임자',
        body: '개인정보 보호책임자는 태영호이며, 연락처는 고객센터 이메일 확정 후 본 방침에 고지합니다.',
    },
]
...
export default function LegalPage({ variant }: LegalPageProps) {
    ...
    const description = isPrivacy
        ? '긱온이 서비스 제공을 위해 처리하는 개인정보와 보관 기준입니다.'
        : '긱온의 의뢰, 결제, 작업 진행, 정산 기준입니다.'
        ...
        <main className="legal-page" aria-labelledby="legal-page-title">
            <section className="legal-hero">
                <div className="container legal-hero-inner">
                    <p className="legal-eyebrow">긱온 정책</p>
